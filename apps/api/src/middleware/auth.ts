...
// Cache JWKS fetchers keyed by issuer URL (lives for the worker instance lifetime)
...
export const requireAuth = createMiddleware<{
  ...
  try {
    // Decode the JWT payload without full verification to extract the issuer URL
